    ...
    children: [
      {
        ...
        icon: Coffee,
        path: 'https://keenthemes.com/Meikannan/tailwind/docs/getting-started/installation',
      },
      {
        title: 'Support Forum',
        icon: AlertCircle,
      ...
      },
      {
        title: 'Licenses & FAQ',
        icon: Captions,
        path: 'https://keenthemes.com/Meikannan/tailwind/docs/getting-started/license',
      },
      {
        title: 'Documentation',
        icon: FileQuestion,
        path: 'https://keenthemes.com/Meikannan/tailwind/docs',
      },
      { separator: true },
      {
        title: 'Contact Us',
